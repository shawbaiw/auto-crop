...
- **CEO Review Request**: A department-submitted request for CEO Office to approve or return work after execution. Departments can submit and track CEO Review Requests, but CEO Office owns the approve/return decision. A checkpoint CEO Review Request returns the task to execution when approved; a completion CEO Review Request completes the task when approved. Department subtask review is internal readiness and is not a CEO Review Request.
...
- **CEO Review Decision**: A durable CEO Office decision on a CEO Review Request. A decision can approve the work or return it with a structured reason and optional note.
